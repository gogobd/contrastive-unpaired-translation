...
# docker exec -it $(docker run --ipc host --gpus all -v /Volumes/remote/nasberrypi03.precalc.org/Public/Shared\ Data/deeplearning/datasets:/datasets -v $(pwd):/app -p 8080:8080 -p 8081:8081 -it -d contrastive-unpaired-translation) cat /root/.config/code-server/config.yaml
